...
def upgrade():
    ...
    op.create_table('directorship_meetings',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('directorship', sa.Enum('Evaluations', 'History', 'Social', 'Opcomm', 'R&D', 'House Improvements', 'Financial', 'Chairman', name='directorships_enum'), nullable=False),
    ...
    op.create_table('freshman_directorship_attendance',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('fid', sa.Integer(), nullable=False),
    sa.Column('meeting_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['fid'], ['freshman_accounts.id'], ),
    sa.ForeignKeyConstraint(['meeting_id'], ['directorship_meetings.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_table('member_directorship_attendance',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('uid', sa.String(length=32), nullable=False),
    sa.Column('meeting_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['meeting_id'], ['directorship_meetings.id'], ),
...
def downgrade():
    ...
    op.drop_table('member_directorship_attendance')
    op.drop_table('freshman_seminar_attendance')
    op.drop_table('freshman_hm_attendance')
    op.drop_table('freshman_directorship_attendance')
    ...
    op.drop_table('directorship_meetings')
    ### end Alembic commands ###
