...
from conditional.util.user_dict import user_dict_is_active, user_dict_is_alumni, user_dict_is_eboard, \
    user_dict_is_eval_director, user_dict_is_financial_director, user_dict_is_intromember, user_dict_is_rtp
