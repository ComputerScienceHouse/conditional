...
RUN mkdir /opt/conditional && mkdir /opt/conditional/frontend && mkdir /opt/conditional/gulpfile.js 
...
COPY .eslintrc .sass-lint.yml .csscomb.json /opt/conditional/
COPY frontend/ /opt/conditional/frontend/
COPY gulpfile.js/ /opt/conditional/gulpfile.js/
